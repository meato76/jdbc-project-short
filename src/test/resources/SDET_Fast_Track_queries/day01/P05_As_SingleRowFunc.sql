...
*/
select FIRST_NAME, SALARY,substr(FIRST_NAME,-3),lower(FIRST_NAME) as lowerFirstname from EMPLOYEES where SALARY >3000 order by substr(lowerFirstname,-3),SALARY desc ;